...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PediburRatingApp.EventListener.TaskCompletionListener, PediburRatingApp", TaskCompletionListener.class, __md_methods);
	}
	...
	public TaskCompletionListener ()
	{
		...
		if (getClass () == TaskCompletionListener.class)
			mono.android.TypeManager.Activate ("PediburRatingApp.EventListener.TaskCompletionListener, PediburRatingApp", "", this, new java.lang.Object[] {  });
	}
