...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PediburRatingApp.Activity.DashBoard, PediburRatingApp", DashBoard.class, __md_methods);
	}
	...
	public DashBoard ()
	{
		...
		if (getClass () == DashBoard.class)
			mono.android.TypeManager.Activate ("PediburRatingApp.Activity.DashBoard, PediburRatingApp", "", this, new java.lang.Object[] {  });
	}
