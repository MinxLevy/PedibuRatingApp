...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PediburRatingApp.EventListener.DriversListener, PediburRatingApp", DriversListener.class, __md_methods);
	}


	public DriversListener ()
	{
		super ();
		if (getClass () == DriversListener.class)
			mono.android.TypeManager.Activate ("PediburRatingApp.EventListener.DriversListener, PediburRatingApp", "", this, new java.lang.Object[] {  });
	}
