...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("XamarinFirebaseAuth.DashBoard, PediburRatingApp", DashBoard.class, __md_methods);
	}
	...
	public DashBoard ()
	{
		...
		if (getClass () == DashBoard.class)
			mono.android.TypeManager.Activate ("XamarinFirebaseAuth.DashBoard, PediburRatingApp", "", this, new java.lang.Object[] {  });
	}
